...
AS
	BEGIN
		DECLARE @TongTriGia INT, @mahd VARCHAR(5)
		SET @mahd = (SELECT @mahd FROM inserted)
		SET @TongTriGia =
		(
	...
	END
SELECT * FROM CTHD
INSERT INTO CTHD VALUES ('HD021', 'VT04', 600, NULL, 300000)
INSERT INTO CTHD VALUES ('HD021', 'VT01', 600, NULL, 300000)
DELETE FROM CTHD
WHERE MAHD = 'HD021'
